...
public class CochesFacade {
	...
	public static Coche creaCocheElectrico1() {
		...
		return new CocheElectrico(1L, "Model S", "Azul", bateria, cinturones, aireAcondicionado, puertas,
				bateraElectrica);
	...
	public static Coche creaCocheElectrico2() {
		...
		return new CocheElectrico(2L, "Renault ZERO", "Azul", bateria, cinturones, aireAcondicionado, puertas,
				bateraElectrica);
	...
	public static Coche creaCocheElectrico3() {
		...
		return new CocheElectrico(3L, "Nissan Leaf", "Rojo", bateria, cinturones, aireAcondicionado, puertas,
				bateraElectrica);
	...
	public static Coche creaCocheGasolina1() {
		...
		return new CocheGasolina(1L, "Renault Megane", "Azul", bateria, cinturones, aireAcondicionado, puertas,
				motorGasolina);
	}
	...
	public static Coche creaCocheGasolina2() {
		...
		return new CocheGasolina(2L, "Peugeot 208", "Rojo", bateria, cinturones, aireAcondicionado, puertas,
				motorGasolina);
	...
	public static Coche creaCocheHibrido1() {
		...
		return new CocheHibrido(1L, "Lexus CT 200h", "Azul", bateria, cinturones, aireAcondicionado, puertas,
				tanqueHidrogeno);
	}
	...
	public static Coche creaCocheHibrido2() {
		...
		return new CocheHibrido(2L, "Honda Jazz", "Rojo", bateria, cinturones, aireAcondicionado, puertas,
				tanqueHidrogeno);
	}
